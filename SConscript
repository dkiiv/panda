...
# if not GetOption('escc'):
customModule = ['escc', 'eepb']
if GetOption() not in customModule: # if we are building custom module code, we don't build anything else
  # panda fw
  ...
  if GetOption('eepb'):
    SConscript('board/eepb/SConscript')